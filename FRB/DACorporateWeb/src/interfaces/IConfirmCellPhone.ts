/**
 * Confirm Cell Phone Interface for DirectAxis Loan Application
 * 
 * This interface defines the Sitecore CMS field structure for the confirm cell phone step
 * of the loan application journey. It contains all content fields that are managed
 * through Sitecore CMS for the confirm cell phone form component.
 * 
 * @file IConfirmCellPhone.ts
 * @description Interface for confirm cell phone form fields and content
 * @version 1.0.0
 */
...
/**
 * Sitecore fields interface for confirm cell phone form content
 * 
 * This interface represents all CMS-managed content fields used in the confirm cell phone
 * step of the loan application process. It includes heading content, form field
 * configurations, and validation settings.
 */
export interface IConfirmCellPhone {
  /**
   * Sub-heading message displayed on the confirm cell phone page
