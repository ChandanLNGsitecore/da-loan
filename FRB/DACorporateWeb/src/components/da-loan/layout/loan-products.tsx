...
export function LoanProducts({ heading, description, products }: Readonly<LoanProductsProps>) {
							...
							<div className="absolute bottom-4 left-4 right-4 bg-gray-900/80 backdrop-blur-sm p-5 rounded-2xl">
								<div className="flex items-start gap-3">
									...
									<div className="flex-1">
										<h3 className="text-xl font-semibold text-white mb-2 group-hover:underline">{product1.title}</h3>
						...
						<div className="relative w-full h-full">
							...
							<div className="absolute top-1/3 left-4 max-w-[85%] bg-gray-900/80 backdrop-blur-sm p-5 rounded-2xl">
								<div className="flex items-start gap-3">
									<CheckCircle2 className="h-6 w-6 text-white shrink-0 mt-0.5" />
									<div className="flex-1">
										<h3 className="text-xl font-semibold text-white mb-2 group-hover:underline">{product2.title}</h3>
